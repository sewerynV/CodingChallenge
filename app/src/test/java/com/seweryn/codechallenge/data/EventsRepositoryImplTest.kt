...
import com.seweryn.codechallenge.data.local.EventsDao
import com.seweryn.codechallenge.data.local.ScheduleDao
...
class EventsRepositoryImplTest : WithMockito {

    private lateinit var systemUnderTest: EventsRepositoryImpl

    @Mock
    lateinit var apiInterface: EventsApi
    ...
    @Before
    fun setUp() {
        systemUnderTest = EventsRepositoryImpl(apiInterface, database)
        mockDatabase()
    }
